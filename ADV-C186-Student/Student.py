...
firebasefire = fb.FirebaseApplication("TODO: Add link here", None)
login_window = Tk()
...
def enterRoom():
    ...
    btn_send = Button(message_window, text="Send", font = 'arial 13', bg="light green", fg="white", padx=10, bd=0)
